...
public class LightBlueFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.light_blue, container, false);
    ...
    public void onClick(View v) {
        ...
        switch(type) {
            case PREV:
                interaction.putExtra(AppContract.FRAGMENT, AppContract.DARK_BLUE);
                break;
            case NEXT:
                interaction.putExtra(AppContract.FRAGMENT, AppContract.BLUE);
                break;
            default:
                break;
        }
