...
public class DarkBlueFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dark_blue, container, false);
    ...
    public void onClick(View v) {
        ...
        switch(type) {
            case PREV:
                ...
                break;
            case NEXT:
                interaction.putExtra(AppContract.FRAGMENT, AppContract.LIGHT_BLUE);
                break;
            default:
                break;
        }
