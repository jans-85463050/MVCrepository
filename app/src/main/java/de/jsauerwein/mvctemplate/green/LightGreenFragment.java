...
public class LightGreenFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.light_green, container, false);
    ...
    public void onClick(View v) {
        ...
        switch(type) {
            case PREV:
                interaction.putExtra(AppContract.FRAGMENT, AppContract.DARK_GREEN);
                break;
            case NEXT:
                interaction.putExtra(AppContract.FRAGMENT, AppContract.DARK_GREEN);
                break;
